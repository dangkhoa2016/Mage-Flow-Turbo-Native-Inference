...
> 🌐 Language / Ngôn ngữ: [English](BF16-SAFETENSORS.md) | **Tiếng Việt**
...
Release contract CPU-only pre-release trước đây đã được thay thế bởi strict v1.0.0 2×2 profile/backend matrix.
