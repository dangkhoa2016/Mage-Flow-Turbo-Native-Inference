...
Tài liệu này định nghĩa benchmark và interpretation contract cho release public đầu tiên **Mage-Flow-Turbo-Native-Inference v1.0.0**. Fresh final measurements chỉ được tạo sau khi redesigned source đã freeze; các số đo được publish trong checksum-protected GitHub Release assets/body thay vì sửa ngược vào source.
...
| Q8 T4 | `q8-reference` | `cuda0` | fresh Kaggle T4/T4x2, chỉ physical slot 0 |
| BF16 T4 | `bf16-safetensors` | `cuda0` | fresh Kaggle T4/T4x2, chỉ physical slot 0 |

Mọi cell phải dùng cùng final source HEAD/TREE và cùng canonical request. Mỗi fresh authority session chỉ attach đúng Mage-Flow-Turbo diffusion family đã chọn.
...
- cùng final source HEAD/TREE ở cả bốn cells;
...
Sau independent review bốn cell archives, frozen comparator tạo:
...
GitHub Release body được lấy từ generated summary. README không được sửa sau qualification chỉ để paste fresh benchmark numbers.
...
Những số này vẫn hữu ích cho pre-release research/regression context nhưng **không** phải final v1.0.0 exact-head authority sau 2×2 redesign. Không được dùng chúng thay cho bốn fresh release cells hoặc đưa vào generated final 2×2 report.

Historical T4 1024 PNG SHA-256 `2c82bdb7cd68746c113eea0f95593d4860b3a201eb3869d0c384221b39b0e49e` cũng chỉ là historical evidence, không phải reference hash cho fresh 512 hoặc BF16 artifact.
