...
> 🌐 Language / Ngôn ngữ: **English** | [Tiếng Việt](BF16-SAFETENSORS.vi.md)
...
The former CPU-only pre-release contract is superseded by the strict v1.0.0 2×2 profile/backend matrix.
